...
flags.DEFINE_string('style_images_paths', 'images/style_images/*.jpg', 'Paths to the style images'
                    'for evaluation.')
flags.DEFINE_string('content_images_paths', 'images/content_images/*.jpg', 'Paths to the content images'
                    'for evaluation.')
    ...
    with tf.Graph().as_default(), tf.Session() as sess:
        ...
        for content_i, content_img_path in enumerate(content_img_list):
            ...
            for style_i, style_img_path in enumerate(style_img_list):
                ...
                print('style_params_tyokuzen:')
                print(np.shape(style_params))
                print('style_img_ph_tyokuzen')
                print(style_img_ph)
                print('style_image_np_tyokuzen')
                print(np.shape(style_image_np))
